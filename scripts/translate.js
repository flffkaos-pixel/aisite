...
5. 트위터/X 인용문/트윗도 자연스러운 한국어로 번역한다. "(번역)" 같은 별도 표기는 붙이지 않는다.
...
9. 출력물에는 일본어가 전혀 남아 있으면 안 된다. (참고: 激化→치열해짐, 話題→화제, まとめ→요약, 行くぞ→가자, 優れた→뛰어난, 凌駕→능가, 操作→조작, 構築→구축, 離れる→벗어나다 등 일본어 어휘/문법/표현은 반드시 자연스러운 한국어로 옮긴다.) 인용문/트윗 원문도 한국어로 번역한다. "(번역)" 표기를 절대 붙이지 않는다. 미번역 일본어 문장 하나도 남기지 않는다.`;
