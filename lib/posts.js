...
function excerptOf(content, maxLen = 240) {
  let text = '';
...
function listPosts() {
  ...
  for (const f of files) {
    ...
    posts.push({ slug, data, content, excerpt: excerptOf(content), path: f });
  }
  // 최신순: slug(20260813_00_morning, YYYYMMDD_HH_요일) 기준 내림차순이 올바른 날짜 순서.
